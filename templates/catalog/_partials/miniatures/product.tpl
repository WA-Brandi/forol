          ...
          {foreach from=$cart.discounts item=discount}
            ...
            <div class="coupon-wrapper">
              <div class="coupon-wrapper__inner">
                <p class="mb-0 text-gray-dark"><span style="font-weight:bold;color:red">{$product.regular_price_amount * (1 - $discount.reduction_percent) }</span> {l s='with code:' d='Shop.Theme.Global'} {$discount.code}</p>
