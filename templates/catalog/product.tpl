...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <section id="main" itemscope itemtype="https://schema.org/Product">
        ...
        <div class="row">
            <div class="col-md-6 product-images-block">
                ...
                *}
                    ...
                    <div class="product-actions">
                        ...
                        <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                            ...
                            {hook h='displayDiscountBanner' product=$product}
...
*}
            ...
            <div id="description" class="product-fullwidth-content">
                ...
                {block name='product_details'}
                <div class="pfc-cont product-details">
                    <h2><img src="{$urls.theme_assets}svg/info-red.svg" alt="" />{l s='Product Details' d='Shop.Theme.Catalog' }</h2>
                    {include file='catalog/_partials/product-details.tpl'}
                </div>
                {/block}
